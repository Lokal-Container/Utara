...
>
* ⚠ **WARN** The most common width is 583 among a set of 2 math glyphs.
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* Q (U+0051): X=827.0,Y=1.0 (should be at baseline 0?)

	* sterling (U+00A3): X=57.0,Y=-1.0 (should be at baseline 0?) 

	* sterling (U+00A3): X=595.0,Y=-1.0 (should be at baseline 0?) [code: found-misalignments]
...
* ⚠ **WARN** The following glyphs have segments which seem very short:
	...
	* k (U+006B) contains a short segment L<<553.0,11.0>--<553.0,0.0>>

	* cedilla (U+00B8) contains a short segment L<<195.0,-37.0>--<198.0,-37.0>>

	* Ccedilla (U+00C7) contains a short segment L<<440.0,-37.0>--<443.0,-37.0>>

	* ccedilla (U+00E7) contains a short segment L<<334.0,-37.0>--<337.0,-37.0>>

	* uni0137 (U+0137) contains a short segment L<<553.0,11.0>--<553.0,0.0>>

	* Scedilla (U+015E) contains a short segment L<<347.0,-37.0>--<350.0,-37.0>>

	* scedilla (U+015F) contains a short segment L<<206.0,-37.0>--<209.0,-37.0>>

	* uni0162 (U+0162) contains a short segment L<<363.0,-37.0>--<366.0,-37.0>>

	* uni0163 (U+0163) contains a short segment L<<326.0,-37.0>--<329.0,-37.0>> 

	* uni0327 (U+0327) contains a short segment L<<195.0,-37.0>--<198.0,-37.0>> [code: found-short-segments]
...
* ⚠ **WARN** The following glyphs have semi-vertical/semi-horizontal lines:
	...
	* logicalnot (U+00AC): L<<326.0,150.0>--<325.0,309.0>> [code: found-semi-vertical]
