...
</div></details><br></div></details><details><summary><b>[95] Utara-Light.ttf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Font contains glyphs for whitespace characters? (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/universal.html#com.google.fonts/check/whitespace_glyphs">com.google.fonts/check/whitespace_glyphs</a>)</summary><div>
...
>
* ⚠ **WARN** The most common width is 671 among a set of 3 math glyphs.
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* exclam (U+0021): X=85.0,Y=725.0 (should be at cap-height 724?)

	* exclam (U+0021): X=152.0,Y=725.0 (should be at cap-height 724?)

	* g (U+0067): X=432.0,Y=-2.0 (should be at baseline 0?)

	* g (U+0067): X=97.0,Y=-2.0 (should be at baseline 0?)

	* uni00B2 (U+00B2): X=216.0,Y=722.0 (should be at cap-height 724?)

	* gbreve (U+011F): X=432.0,Y=-2.0 (should be at baseline 0?)

	* gbreve (U+011F): X=97.0,Y=-2.0 (should be at baseline 0?)

	* gdotaccent (U+0121): X=432.0,Y=-2.0 (should be at baseline 0?)

	* gdotaccent (U+0121): X=97.0,Y=-2.0 (should be at baseline 0?)

	* uni0123 (U+0123): X=432.0,Y=-2.0 (should be at baseline 0?) 
...
* ⚠ **WARN** The following glyphs have segments which seem very short:
	...
	* dollar (U+0024) contains a short segment B<<277.0,687.0>-<286.0,687.0>-<294.0,687.0>>

	* dollar (U+0024) contains a short segment B<<267.0,37.0>-<263.0,37.0>-<259.0,37.0>>

	* k (U+006B) contains a short segment L<<507.0,7.0>--<507.0,0.0>>

	* uni00B2 (U+00B2) contains a short segment L<<214.0,495.0>--<209.0,495.0>>

	* onehalf (U+00BD) contains a short segment L<<656.0,177.0>--<653.0,177.0>>

	* germandbls (U+00DF) contains a short segment L<<158.0,500.0>--<158.0,506.0>>

	* uni0137 (U+0137) contains a short segment L<<507.0,7.0>--<507.0,0.0>> 

	* uni2082 (U+2082) contains a short segment L<<214.0,142.0>--<209.0,142.0>> [code: found-short-segments]
...
* ⚠ **WARN** The following glyphs have colinear vectors:
	...
	* fiveeighths (U+215D): L<<223.0,14.0>--<459.0,362.0>> -> L<<459.0,362.0>--<665.0,724.0>>

	* fiveeighths (U+215D): L<<727.0,710.0>--<491.0,362.0>> -> L<<491.0,362.0>--<285.0,0.0>>

	* fraction (U+2044): L<<-126.0,14.0>--<110.0,362.0>> -> L<<110.0,362.0>--<316.0,724.0>>

	* fraction (U+2044): L<<378.0,710.0>--<142.0,362.0>> -> L<<142.0,362.0>--<-64.0,0.0>>

	* oneeighth (U+215B): L<<109.0,14.0>--<345.0,362.0>> -> L<<345.0,362.0>--<551.0,724.0>>

	* oneeighth (U+215B): L<<613.0,710.0>--<377.0,362.0>> -> L<<377.0,362.0>--<171.0,0.0>>

	* onehalf (U+00BD): L<<109.0,14.0>--<345.0,362.0>> -> L<<345.0,362.0>--<551.0,724.0>>

	* onehalf (U+00BD): L<<613.0,710.0>--<377.0,362.0>> -> L<<377.0,362.0>--<171.0,0.0>>

	* onequarter (U+00BC): L<<109.0,14.0>--<345.0,362.0>> -> L<<345.0,362.0>--<551.0,724.0>>

	* onequarter (U+00BC): L<<613.0,710.0>--<377.0,362.0>> -> L<<377.0,362.0>--<171.0,0.0>> 
...
* ⚠ **WARN** The following glyphs have jaggy segments:
	...
	* uni262F (U+262F): B<<685.5,428.0>-<721.0,399.0>-<730.0,328.0>>/L<<730.0,328.0>--<730.0,363.0>> = 7.224315694045308 [code: found-jaggy-segments]
...
* ⚠ **WARN** The following glyphs have semi-vertical/semi-horizontal lines:
	...
	* ampersand (U+0026): L<<231.0,407.0>--<680.0,408.0>>

	* arrowdown (U+2193): L<<322.0,725.0>--<320.0,215.0>>

	* arrowleft (U+2190): L<<816.0,330.0>--<306.0,331.0>>

	* arrowright (U+2192): L<<605.0,331.0>--<95.0,330.0>>

	* logicalnot (U+00AC): L<<415.0,178.0>--<414.0,374.0>>

	* uni2196 (U+2196): L<<95.0,633.0>--<352.0,634.0>> 

	* uni2197 (U+2197): L<<366.0,634.0>--<623.0,633.0>> [code: found-semi-vertical]
