...
>
* ⚠ **WARN** The most common width is 624 among a set of 2 math glyphs.
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* exclam (U+0021): X=64.0,Y=725.0 (should be at cap-height 724?)

	* exclam (U+0021): X=175.0,Y=725.0 (should be at cap-height 724?)

	* Q (U+0051): X=833.0,Y=1.0 (should be at baseline 0?)

	* g (U+0067): X=30.0,Y=-1.0 (should be at baseline 0?)

	* g (U+0067): X=518.0,Y=-1.0 (should be at baseline 0?)

	* questiondown (U+00BF): X=177.0,Y=2.0 (should be at baseline 0?)

	* gbreve (U+011F): X=30.0,Y=-1.0 (should be at baseline 0?)

	* gbreve (U+011F): X=518.0,Y=-1.0 (should be at baseline 0?)

	* gdotaccent (U+0121): X=30.0,Y=-1.0 (should be at baseline 0?)

	* gdotaccent (U+0121): X=518.0,Y=-1.0 (should be at baseline 0?) 
...
* ⚠ **WARN** The following glyphs have segments which seem very short:
	...
	* k (U+006B) contains a short segment L<<535.0,9.0>--<535.0,0.0>>

	* cent (U+00A2) contains a short segment B<<314.0,105.0>-<308.0,105.0>-<302.0,105.0>>

	* cent (U+00A2) contains a short segment L<<312.0,207.0>--<314.0,207.0>>

	* uni0137 (U+0137) contains a short segment L<<535.0,9.0>--<535.0,0.0>> 

	* uni1E9E (U+1E9E) contains a short segment L<<399.0,396.0>--<412.0,410.0>> [code: found-short-segments]
...
* ⚠ **WARN** The following glyphs have jaggy segments:
	...
	* uni1E9E (U+1E9E): L<<584.0,606.0>--<399.0,396.0>>/L<<399.0,396.0>--<412.0,410.0>> = 1.500388307455604 
...
* ⚠ **WARN** The following glyphs have semi-vertical/semi-horizontal lines:
	...
	* arrowdown (U+2193): L<<342.0,264.0>--<498.0,265.0>>

	* arrowdown (U+2193): L<<82.0,264.0>--<239.0,265.0>> 

	* logicalnot (U+00AC): L<<362.0,162.0>--<361.0,335.0>> [code: found-semi-vertical]
