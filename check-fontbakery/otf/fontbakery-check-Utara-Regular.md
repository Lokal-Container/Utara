...
>
* ⚠ **WARN** The most common width is 641 among a set of 2 math glyphs.
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* exclam (U+0021): X=159.0,Y=725.0 (should be at cap-height 724?)

	* exclam (U+0021): X=78.0,Y=725.0 (should be at cap-height 724?)

	* Aogonek (U+0104): X=593.0,Y=1.0 (should be at baseline 0?) 

	* uni2082 (U+2082): X=41.0,Y=1.0 (should be at baseline 0?) [code: found-misalignments]
...
* ⚠ **WARN** The following glyphs have segments which seem very short:
	...
	* dollar (U+0024) contains a short segment B<<263.0,37.0>-<265.0,37.0>-<267.0,37.0>-<269.0,37.0>>

	* dollar (U+0024) contains a short segment B<<292.0,687.0>-<288.0,687.0>-<285.0,687.0>-<281.0,687.0>>

	* two (U+0032) contains a short segment B<<281.0,298.0>-<284.0,298.0>-<288.0,298.0>-<293.0,298.0>>

	* k (U+006B) contains a short segment L<<516.0,0.0>--<516.0,7.0>>

	* cent (U+00A2) contains a short segment B<<321.0,181.0>-<315.0,181.0>-<310.0,181.0>-<304.0,182.0>>

	* Iogonek (U+012E) contains a short segment L<<180.0,0.0>--<179.0,0.0>>

	* iogonek (U+012F) contains a short segment L<<157.0,0.0>--<156.0,0.0>>

	* uni0137 (U+0137) contains a short segment L<<516.0,0.0>--<516.0,7.0>>

	* uni0162 (U+0162) contains a short segment L<<336.0,0.0>--<353.0,0.0>> 

	* uni0162 (U+0162) contains a short segment L<<268.0,0.0>--<283.0,0.0>> [code: found-short-segments]
...
* ⚠ **WARN** The following glyphs have semi-vertical/semi-horizontal lines:
	...
	* ampersand (U+0026): L<<682.0,413.0>--<242.0,412.0>>

	* arrowdown (U+2193): L<<228.0,231.0>--<83.0,230.0>>

	* arrowdown (U+2193): L<<229.0,724.0>--<228.0,231.0>>

	* arrowdown (U+2193): L<<449.0,231.0>--<305.0,230.0>>

	* arrowleft (U+2190): L<<308.0,325.0>--<801.0,324.0>>

	* arrowleft (U+2190): L<<801.0,400.0>--<308.0,401.0>>

	* arrowright (U+2192): L<<573.0,401.0>--<80.0,400.0>>

	* arrowright (U+2192): L<<574.0,325.0>--<573.0,180.0>>

	* arrowright (U+2192): L<<574.0,546.0>--<573.0,401.0>>

	* arrowright (U+2192): L<<80.0,324.0>--<574.0,325.0>> 
