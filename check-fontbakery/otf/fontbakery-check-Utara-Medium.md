...
>
* ⚠ **WARN** The most common width is 632 among a set of 2 math glyphs.
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* exclam (U+0021): X=167.0,Y=725.0 (should be at cap-height 724?)

	* exclam (U+0021): X=71.0,Y=725.0 (should be at cap-height 724?)

	* g (U+0067): X=512.0,Y=-2.0 (should be at baseline 0?)

	* g (U+0067): X=30.0,Y=-2.0 (should be at baseline 0?)

	* questiondown (U+00BF): X=168.0,Y=-1.0 (should be at baseline 0?)

	* Aogonek (U+0104): X=584.0,Y=1.0 (should be at baseline 0?)

	* gbreve (U+011F): X=512.0,Y=-2.0 (should be at baseline 0?)

	* gbreve (U+011F): X=30.0,Y=-2.0 (should be at baseline 0?)

	* gdotaccent (U+0121): X=512.0,Y=-2.0 (should be at baseline 0?)

	* gdotaccent (U+0121): X=30.0,Y=-2.0 (should be at baseline 0?)

	* uni0123 (U+0123): X=512.0,Y=-2.0 (should be at baseline 0?) 

	* uni0123 (U+0123): X=30.0,Y=-2.0 (should be at baseline 0?) [code: found-misalignments]
...
* ⚠ **WARN** The following glyphs have segments which seem very short:
	...
	* dollar (U+0024) contains a short segment B<<268.0,37.0>-<269.0,37.0>-<270.0,37.0>-<271.0,37.0>>

	* dollar (U+0024) contains a short segment B<<289.0,687.0>-<288.0,687.0>-<286.0,687.0>-<284.0,687.0>>

	* k (U+006B) contains a short segment L<<525.0,0.0>--<525.0,8.0>>

	* cent (U+00A2) contains a short segment B<<317.0,194.0>-<314.0,194.0>-<311.0,194.0>-<308.0,194.0>>

	* iogonek (U+012F) contains a short segment L<<165.0,0.0>--<164.0,0.0>>

	* uni0137 (U+0137) contains a short segment L<<525.0,0.0>--<525.0,8.0>>

	* uni0162 (U+0162) contains a short segment L<<344.0,0.0>--<364.0,0.0>> 

	* uni0162 (U+0162) contains a short segment L<<264.0,0.0>--<283.0,0.0>> [code: found-short-segments]
...
* ⚠ **WARN** The following glyphs have semi-vertical/semi-horizontal lines:
	...
	* ampersand (U+0026): L<<685.0,418.0>--<253.0,417.0>>

	* arrowdown (U+2193): L<<233.0,248.0>--<82.0,247.0>>

	* arrowdown (U+2193): L<<234.0,724.0>--<233.0,248.0>>

	* arrowdown (U+2193): L<<474.0,248.0>--<324.0,247.0>>

	* arrowleft (U+2190): L<<321.0,318.0>--<797.0,317.0>>

	* arrowleft (U+2190): L<<797.0,407.0>--<321.0,408.0>>

	* arrowright (U+2192): L<<551.0,408.0>--<75.0,407.0>>

	* arrowright (U+2192): L<<552.0,318.0>--<551.0,167.0>>

	* arrowright (U+2192): L<<552.0,559.0>--<551.0,408.0>>

	* arrowright (U+2192): L<<75.0,317.0>--<552.0,318.0>> 
